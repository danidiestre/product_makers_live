      ...
      <Card className={styles.card}>
        ...
        <CardContent className={styles.cardContent}>
          {app.screenshots && app.screenshots.length > 0 ? (
            <Carousel
              className="border border-border bg-background rounded-xl aspect-auto"
        ...
        <CardContent className={styles.cardContent}>
          <div className="bg-muted rounded-xl p-12">
            <div className="text-center">
              ...
              <h3 className="text-xl font-medium mb-1">Únete a la conversación</h3>
              <p className="font-medium text-sm mb-6">Entra en Discord para dejar un comentario</p>
              <Button
                asChild
                size="default"
                className="bg-[#5865F2] hover:bg-[#5865F2] text-white font-medium border-0"
              >
                <Link
