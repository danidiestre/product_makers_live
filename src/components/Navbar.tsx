  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-background border-b">
      <LayoutContainer className="w-full h-16 flex flex-shrink-0 flex-row items-center justify-between md:grid md:grid-cols-3 gap-6">
        ...
        <div className="flex">
          <Link href="/" className="flex items-start justify-start gap-2" legacyBehavior>
        ...
        <Link
          href="/"
          className="hidden items-center justify-start gap-2 whitespace-nowrap"
          legacyBehavior>
            ...
            <DropdownMenuContent className="w-56" align="end">
              ...
              <DropdownMenuGroup>
                <DropdownMenuItem asChild>
                  <Link href="/profile" className="w-full cursor-pointer" legacyBehavior>
                    <User className="mr-2 h-4 w-4" />
                    <span>Perfil</span>
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link href="/settings" className="w-full cursor-pointer" legacyBehavior>
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem asChild>
                <Link href="/login" className="w-full cursor-pointer" legacyBehavior>
