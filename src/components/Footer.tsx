        ...
        <div className="flex items-center gap-2">
          ...
          >
            <Link
              ...
              className="group"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-muted-foreground group-hover:text-[#FF0000] transition-colors">
          ...
          >
            <Link
              ...
              className="group"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-muted-foreground group-hover:text-[#5865F2] transition-colors">
