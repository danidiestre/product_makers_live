  ...
  const features = [
    {
      ...
      description: 'Access cutting-edge tools and resources designed specifically for product makers.'
    },
    {
      icon: (
      ...
      description: 'Connect with a vibrant community of like-minded makers to share insights and feedback.'
    },
    {
      icon: (
      ...
      title: 'Launch Faster',
      description: 'Streamline your product development and go-to-market process with proven frameworks.'
    },
    {
      icon: (
      ...
      description: 'Get real data and actionable insights to continuously improve your products.'
    },
    {
      icon: (
      ...
      description: 'Access comprehensive guides, tutorials, and learning paths curated by industry experts.'
    },
    {
      icon: (
      ...
      title: 'Automation',
      description: 'Automate repetitive tasks and workflows to focus on what matters most: creating.'
    }
  ]
    ...
    <section className="py-20 bg-muted/50">
      <div className="container">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold tracking-tight mb-4">Everything You Need to Build Amazing Products</h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Our platform provides all the tools, resources and community support to help you create, launch, and grow your products.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="bg-background p-6 rounded-lg shadow-sm border flex flex-col gap-4">
